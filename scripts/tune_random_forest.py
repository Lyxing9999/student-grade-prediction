...
# Smaller search sample keeps tuning practical on your Mac.
...
def main() -> None:
    ...
    # Avoid nested parallel processing during cross-validation.
    ...
    # Use all CPU cores only for the final full-data fit.
    ...
    print("\n=== TUNED FOREST INFORMATION ===")
    print(f"Number of trees: {forest.n_estimators}")
    print(f"Maximum depth: {forest.max_depth}")
    print(f"Class weight: {forest.class_weight}")
