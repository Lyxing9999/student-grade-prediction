...
from src.models.adaboost import create_adaboost
...
def main() -> None:
    ...
    adaboost = final_model.named_steps["model"]

    print("\n=== TUNED ADABOOST INFORMATION ===")
    print(f"Number of estimators: {adaboost.n_estimators}")
    print(f"Learning rate: {adaboost.learning_rate}")
    print(
        "Estimator maximum depth: "
        f"{adaboost.estimator.max_depth}"
    )
